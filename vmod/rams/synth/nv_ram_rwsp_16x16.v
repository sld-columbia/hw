...
// nv_ram_rwsp_16x16: synthesizable model wrapper
...
// This wrapper consists of :  1 Ram cells: RAMDP_16X16_GL_M1_E2 ;  
...
nv_ram_rwsp_16x16_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rwsp_16x16 (
...
// initializing RAMDP_16X16_GL_M1_E2
for (row = 0; row < 16; row = row + 1)
 if (shadow_written[row]) r_nv_ram_rwsp_16x16.ram_Inst_16X16.mem_write(row - 0, shadow_mem[row][15:0]);
...
// probing RAMDP_16X16_GL_M1_E2
 if (row >=  0 &&  row < 16) data[15:0] = r_nv_ram_rwsp_16x16.ram_Inst_16X16.mem_read(row - 0);
    probe_mem_val = data;
